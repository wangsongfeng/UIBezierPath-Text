...
-(void)text{
    ...
    _shapeLayer.frame=CGRectMake(0, 0, 200, 50);
...
-(void)Click{
    ...
    UIBezierPath *headPath = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(self.frame.size.width/2-80, 0, 160, 160) cornerRadius:80];
...
//        [weakSelf addAnimation:layer duration:3];
    });
}
